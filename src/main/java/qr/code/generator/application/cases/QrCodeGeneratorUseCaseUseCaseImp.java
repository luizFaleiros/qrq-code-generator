...
@Service
public class QrCodeGeneratorUseCaseUseCaseImp implements QrCodeGeneratorUseCase {
    private final StoragePort storagePort;
    private final MeterRegistry meterRegistry;

    public QrCodeGeneratorUseCaseUseCaseImp(StoragePort storagePort, MeterRegistry meterRegistry) {
